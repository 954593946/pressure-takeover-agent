...
data class WearableGatewaySnapshot(
    ...
    val lastOutboxSource: String = "",
    val lastAgentCommandId: String = "",
    val lastAgentCommandMode: String = "",
    val lastAgentCommandText: String = "",
    val lastAgentCommandHaptic: String = "",
