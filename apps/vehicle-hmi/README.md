...
驾驶主屏遵循“一屏一事”：中央区域优先保留导航、ETA 和任务卡；Agent 交互与确认按钮固定在主驾驶侧，便于驾驶员侧快速求助、查看接管方案并完成确认；右侧只保留速度、腕上/手机/控制台同步状态。消息草稿、方案、行程详情、车况和三端同步等信息通过主驾驶侧浮层面板查看，不使用整屏灰色遮罩，不在主屏平铺，避免遮挡导航和任务卡。
